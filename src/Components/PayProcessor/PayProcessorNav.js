      ...
      <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul className="navbar-nav">
           <li className="nav-item m-2">
            <Link className="nav-link" to="/payprocesssordetails">Home</Link>
          </li>
          <li className="nav-item m-2">
            <Link className="nav-link" to="/updatepayrollprocessor">Account</Link>
          </li>
          <li className="nav-item m-2">
            <Link className="nav-link" to="/payrollprocessor">Payroll</Link>
          </li>
          <li className="nav-item m-2">
...
export default PayProcessorNav