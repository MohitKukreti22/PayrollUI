...
import React, { useState, useEffect } from 'react';
import './ManagerProfile.css'; // Make sure to create and link this CSS file
...
const ManagerProfile = () => {
  ...
  const [newPhone, setNewPhone] = useState('');
  const [response, setResponse] = useState(null);
  const [activeCard, setActiveCard] = useState(null); // State to control which card is active
  const [token, setToken] = useState('');
  ...
  return (
    <div className="manager-profile-layout">
      <div className="manager-sidebar">
        <button onClick={() => setActiveCard('updatePhone')} className="sidebar-button">Update Phone</button>
        <button onClick={() => setActiveCard('updateName')} className="sidebar-button">Update Name</button>
        <button onClick={() => setActiveCard('response')} className="sidebar-button">View Response</button>
      </div>
      <div className="manager-content">
        {activeCard === 'updatePhone' && (
          <div className="card">
            <div className="card-body">
              <h3>Update Phone Number</h3>
              <form onSubmit={handlePhoneSubmit}>
                <div className="mb-3">
                  <label htmlFor="newPhone" className="forms-label">New Phone Number:</label>
                  <input type="tel" className="forms-control" id="newPhone" value={newPhone} onChange={(e) => setNewPhone(e.target.value)} />
                </div>
        ...
        {activeCard === 'updateName' && (
          <div className="card">
            <div className="card-body">
              <h3>Update Name</h3>
              <form onSubmit={handleNameSubmit}>
                <div className="mb-3">
                  <label htmlFor="newName" className="forms-label">New Name:</label>
                  <input type="text" className="forms-control" id="newName" value={newName} onChange={(e) => setNewName(e.target.value)} />
                </div>
                <button type="submit" className="btn btn-primary">Submit</button>
              </form>
            </div>
