    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        ...
        <li className="nav-item m-2">
            <Link className="nav-link" to="/mangerDetails">Home</Link>
          </li>
          <li className="nav-item m-2">
            <Link className="nav-link" to="/updateManager">Account</Link>
          </li>
          <li className="nav-item m-2">
            <Link className="nav-link" to="/ManageRequest">Leave Request</Link>
          </li>
          <li className="nav-item m-2">
