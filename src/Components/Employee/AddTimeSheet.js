...
import React, { useState, useEffect } from 'react';
import './AddTimesheet.css'; // Ensure this CSS file is created and linked correctly
                    ...
                    <div className="timesheet-body">
                        <form onSubmit={handleSubmit}>
                            <div className="input-group">
                                ...
                                <input type="date" id="weekStartDate" value={weekStartDate} onChange={(e) => setWeekStartDate(e.target.value)} />
                            </div>
                            <div className="input-group">
                                <label htmlFor="weekEndDate">Week End Date:</label>
                                <input type="date" id="weekEndDate" value={weekEndDate} onChange={(e) => setWeekEndDate(e.target.value)} />
                            </div>
                            <div className="input-group">
                                <label htmlFor="totalHoursWorked">Total Hours Worked:</label>
                                <input type="number" id="totalHoursWorked" value={totalHoursWorked} onChange={(e) => setTotalHoursWorked(e.target.value)} />
                            </div>
                            <div className="input-group">
                        ...
                        <button className="toggle-response-btn" onClick={() => setShowResponse(prevState => !prevState)}>
                            {showResponse ? 'Hide ' : 'Show Timesheet'}
                        </button>
                    </div>
                </div>
